...
$evento = new Evento($_POST['titolo'], $_POST['info'], null, $ingresso, $_POST['localita'], $_POST['regione'], $_POST['provincia'], $data, $_POST['orario'], $_POST['posti'], $_POST['telefono'], $_POST['email']);
