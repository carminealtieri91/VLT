    ...
    background-color:white
        ...
        <script type="text/javascript">
			...
			function caricaEventi(){
				try{
   				...
   				parametro=parametro.substring(1);
                                url="recuperaEventiOrdinati.php?"+parametro;
			...
			function ordinaPer(criterio){
				...
				location.href="eventiOrdinati.php?criterio="+criterio+"&&regione="+regione;	
			}

 			function filtraPer(criterio){
                                var cerca="regione" ;
                                var ricerca="<?php echo $regione ?>";
        ...
        ?>
        <div id="header">
            <h1> Eventi ordinati per '<?php echo $_GET['criterio']; ?>' </h1>
        </div>
        <div id="content">
